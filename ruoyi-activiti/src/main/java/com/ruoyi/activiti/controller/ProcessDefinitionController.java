...
public class ProcessDefinitionController extends BaseController {
    ...
    public Rest getDefinitionsByInstanceId(@PathVariable("instanceId") String instanceId){
        return Rest.success(processDefinitionService.getDefinitionsByInstanceId(instanceId));
    }
    ...
    public Rest delDefinition(@PathVariable("deploymentId") String deploymentId) {
    ...
    public Rest uploadStreamAndDeployment(@RequestParam("file") MultipartFile file) throws IOException {
    ...
    @ResponseBody
    public Rest suspendOrActiveApply(@RequestBody ProcessDefinitionDTO processDefinition) {
    ...
    public Rest upload(@RequestParam("processFile") MultipartFile multipartFile) throws IOException {

        if (!multipartFile.isEmpty()) {
            String fileName = processDefinitionService.upload(multipartFile);
            return Rest.success("操作成功", fileName);

        }
        return Rest.error("不允许上传空文件！");
    }
    ...
    public Rest addDeploymentByString(@RequestParam("stringBPMN") String stringBPMN) {
