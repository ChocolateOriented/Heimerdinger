    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['finance:stockDict:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['finance:stockDict:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['finance:stockDict:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['finance:stockDict:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="stockDictList" @selection-change="handleSelectionChange">
...
<script>
import { listStockDict, getStockDict, delStockDict, addStockDict, updateStockDict, exportStockDict } from "@/api/finance/stockDict";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listStockDict(this.queryParams).then(response => {
        this.stockDictList = response.rows;
